                ...
                {steps.map((step, index) => (
                    <div key={step} className="flex items-center justify-between">
                        <div className="relative flex flex-col items-center">
                            <div
                                className={`w-10 h-10 rounded-full flex items-center justify-center border-2 bg-muted z-10 
                                    ${step < currentStep
                                        ? "bg-zinc-800 border-zinc-800 text-white"
                                        : step === currentStep
                                            ? "border-muted-foreground text-muted-foreground"
                                            : "border-muted text-gray-300"
                                    }`}
                            >
                            ...
                            <span
                                className={`mt-2 text-sm
                                    ${step === currentStep ? "text-zinc-500" : step < currentStep ? "text-muted-foreground" : "text-gray-400"}`}
                            >
